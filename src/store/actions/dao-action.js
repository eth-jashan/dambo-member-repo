...
//             if(lastSelected){
//               const isLastSelection = lastSelected.filter(x=>x.address === address)            
//               res.data.data.map((item, index)=>{
//                 if(isLastSelection.length>0 && item?.dao_details?.uuid === isLastSelection[0]?.dao_uuid){
...
//               community_role: res.data.data[selectionIndex].community_role,
...
// //                   item: { contri_detail: item, payout: payout },
// //                 })
// //             })
// //             if(payout?.length > 0){
...
// //         dispatch(
// //           daoAction.set_all_payout_request({ list: res.data?.data?.payouts })
// //         );
...
// //           if (
// //             x.nonce === item.nonce &&
// //             (x.request_type === "APPROVED" || x.request_type === "REJECTED") &&
// //             !x.is_executed
// //           ) {
// //             if (item.isExecuted) {
