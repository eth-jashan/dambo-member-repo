          ...
          <div>
            {account_mode === "ADMIN" && (
              <div
                ...
                style={{
                  background: roleContainerHover ? "white" : "#5D5C5D",
                  cursor: "pointer",
                }}
                className={styles.roleSwitchContainer}
              >
                <div
                  style={{ color: roleContainerHover ? "black" : "white" }}
                ...
                </div>
                {
                  <AiFillCaretDown
                    color={
                      switchRoleModal || roleContainerHover ? "black" : "white"
                    }
    ...
    <div className={styles.layout}>
          ...
          <div className={styles.accountContainer}>
            ...
            >
              <div
                ...
                style={{
                  height: "2.25rem",
                  borderRadius: !item?.dao_details?.logo_url ? 0 : "2.25rem",
                  width: "100%",
      ...
      <div className={styles.childrenLayout}>
        ...
        <div className={styles.layoutContainer}>
          ...
          {/* {role === 'ADMIN' && */}
          <div className={styles.adminStats}>{renderSideBarComp()}</div>
        </div>
      </div>
    </div>
  );
