        ...
        <div className={styles.requestItem}>
            ...
            >
                ...
                <Typography.Paragraph
                    ...
                    ellipsis={{ rows: 1 }}
                    className={`${textStyles.ub_19} ${styles.alignText}`}
                >
            ...
            <div className={styles.infoContainer}>
                <div style={{ width: "60%", marginLeft: "0.75rem" }}>
                    <div className={`${textStyles.m_16} ${styles.alignText}`}>
                        {item?.contri_detail?.stream?.toLowerCase()} •{" "}
                        {item?.contri_detail?.time_spent} hrs
                    </div>
                    <div className={`${textStyles.m_16} ${styles.alignText}`}>
                        {
                            item?.contri_detail?.requested_by?.metadata?.name?.split(
                                " "
                            )[0]
                        }{" "}
                        •{" "}
                        {`${item?.contri_detail?.requested_by?.public_address?.slice(
                            0,
                            4
                        )}...${item?.contri_detail?.requested_by?.public_address?.slice(
                            -3
                ...
                <div>
                    ...
                    <div
                        style={{ textAlign: "end" }}
                        className={`${textStyles.m_16} ${styles.usdText}`}
                    >
