...
import { set_contri_filter } from '../../store/actions/dao-action'
      ...
      const renderSearchBar = () => (
          <div className={styles.searchContainer}>
              ...
              <div style={{display:'flex', flexDirection:'row', height:'100%', alignItems:'center'}}>
                ...
                {/* <BiSearchAlt2 color='white' className={styles.searchIcon}  /> */}
              </div>
          </div>
        )
    ...
    return(
        ...
        <div className={styles.container}>
            ...
            <div className={`${textStyles.m_16} ${styles.text}`}>
                {contribution_request?.length} {contri_filter[contriFilter]}
            </div>
            </Dropdown>
