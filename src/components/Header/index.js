...
export default function HeaderComponent() {
    ...
    const renderMenu = () => (
        <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            <div className={styles.menuTextMiddle}>Treasury</div>
            <div className={styles.menuTextMiddle}>Contribution</div>
            <div className={styles.menuTextMiddle}>Growth</div>
            <div lassName={styles.menuTextMiddle}>Settings</div>
        </div>
    )
    ...
    const renderWalletPicker = () => (
        <Dropdown onClick={(e) => e.preventDefault()} overlay={walletMenu}>
            ...
            >
                ...
                >
                    ETH . 0x9D7B838fF3F3A5E576da461920B633c80F040
                </Typography.Text>
            </div>
        </Dropdown>
    )
    ...
    return (
        <Row className={styles.rowContainer}>
            <div style={{ width: "70vw" }}>
                <Col>{renderLogo()}</Col>
                <Col style={{ alignSelf: "center" }}>{renderMenu()}</Col>
