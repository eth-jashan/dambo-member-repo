...
const GnosisExternalPayment = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <div>
                <div
                    style={{ color: "#FFC664", textAlign: "start" }}
                    className={textStyles.ub_16}
                >
                    Transaction pending on Gnosis,
                </div>
                <div
                    style={{ color: "#FFC664", textAlign: "start" }}
                    className={textStyles.m_16}
                >
                    Execute it first to execute pending payments.
                    <a
                        href={`https://gnosis-safe.io/app/rin:${currentDao?.safe_public_address}/balances`}
                        style={{
